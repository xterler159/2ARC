...
class Interface(Thread):
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if 50 < mousse[1] <= 75:
                    ...
                    self.__minrule = 0
                    self.__mode = "read"
                elif 115 < mousse[0] <= 140 and 0 < mousse[1] <= 25:  # Save button
                    ...
                    self.__minrule = 0
                    self.__mode = "read"
                    pygame.display.set_caption("Firewall Cap File Reader Loading...")
    ...
    def run(self):
        pygame.init()
        pygame.display.set_caption("Firewall Cap File Reader")
